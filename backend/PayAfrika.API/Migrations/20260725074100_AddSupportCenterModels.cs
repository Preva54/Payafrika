...
{
    /// <inheritdoc />
    public partial class AddSupportCenterModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KnowledgeBaseArticles_Users_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinkedBanks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LinkedBanks_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketSatisfactions_SupportTickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "SupportTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketSatisfactions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KnowledgeBaseArticles_IsFeatured",
                table: "KnowledgeBaseArticles",
                column: "IsFeatured");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportCategories_DisplayOrder",
                table: "SupportCategories",
                column: "DisplayOrder");

            migrationBuilder.CreateIndex(
                name: "IX_SupportCategories_Key",
                table: "SupportCategories",
                column: "Key",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketSatisfactions_TicketId_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletBalances_UserId_Currency",
